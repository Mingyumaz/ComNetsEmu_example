...
# HEADER_COMBINER_DATA =      0b00000100               # ?
# HEADER_COMBINER_FINISH =    0b00001000               # ?
HEADER_INIT =               0b00010000               # sending init data without calucate
HEADER_DATA =               0b00100000               # ?
HEADER_FINISH =             0b01000000               # calculate finish
HEADER_FEEDBACK =           0b10000000               # feekback from server
